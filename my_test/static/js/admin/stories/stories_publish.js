...
// ================== 上传至七牛（云存储平台） ================
 ...
 // ================== 发布/更新文章 ================
  ...
  $storiesBtn.click(function () {
    ...
    let storiesId = $(this).data("news-id");
    let url = storiesId ? '/admin/stories_publish/' + storiesId + '/' : '/admin/stories_publish/';
      ...
      .done(function (res) {
        if (res.errno === "0") {
          if (storiesId) {
              ...
              setTimeout(function () {
                window.location.href='/admin/stories_edit/'+ storiesId + '/';
                }, 800)
