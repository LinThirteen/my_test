// 创建static/js/admin/user/users_manage.js文件
...
$(function () {
  ...
  $usersBtn.click(function () {
    ...
    $.ajax({
      ...
      .done(function (res) {
        if (res.errno === "0") {
          fAlert.alertNewsSuccessCallback("用户权限更新成功", '跳到用户管理页', function () {
